...
export default jsxRenderer(({ children }, c) => {
  ...
  return (
    <div class="flex min-h-[calc(100vh-70px)] bg-[#121217] w-full border-t border-slate-800/50">
      
      {/* SIDEBAR NAVIGATION (Desktop) */}
      <aside class="hidden md:flex flex-col w-64 bg-[#18181b] border-r border-slate-800/60 py-6">
        <div class="px-6 mb-8">
