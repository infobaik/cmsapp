    ...
    <div class="max-w-6xl mx-auto space-y-6">
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <div class="flex items-center gap-3 bg-[#18181b] border border-slate-800/60 p-2 pr-4 rounded-full">
          <div class="w-8 h-8 rounded-full bg-emerald-500/20 text-emerald-400 flex items-center justify-center font-bold text-sm shrink-0">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-[#18181b] border border-slate-800/60 rounded-2xl p-6 relative overflow-hidden group">
          ...
          <p class="text-xs text-emerald-400 mt-2 font-medium flex items-center gap-1">
            <svg width="14" height="14" class="w-3.5 h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" /></svg> Siap digunakan
          </p>
        </div>
