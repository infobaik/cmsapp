  ...
  return c.render(
    <div class="max-w-4xl mx-auto space-y-6">
      ...
      <div class="mb-6 flex items-center gap-4">
        ...
        <h1 class="text-2xl font-bold text-slate-100">Tambah Provider</h1>
      </div>
        ...
        <form method="POST" action="/api/admin/v1/providers/create" class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="md:col-span-2">
              <label class="block text-xs font-semibold text-slate-500 mb-2">Nama Provider (Contoh: Digiflazz)</label>
            ...
            <div>
              <label class="block text-xs font-semibold text-amber-500 mb-2">API Key (Username/Key)</label>
            ...
            <div>
              <label class="block text-xs font-semibold text-amber-500 mb-2">API Secret (Production Key)</label>
              <input type="password" name="api_secret" class="w-full bg-[#121217] border border-slate-800/60 focus:border-amber-500/50 rounded-xl p-3 text-slate-200 outline-none font-mono" placeholder="Opsional jika provider hanya butuh API Key" />
            </div>
          </div>
