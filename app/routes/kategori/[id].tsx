...
export default createRoute(async (c) => {
  ...
  return c.render(
    <div class="pb-12">
      {hasSub ? (
        /* ========================================================= */
        /* MODE 1: TAMPILAN SUB-KATEGORI (PERSIS SEPERTI HOMEPAGE)   */
        /* ========================================================= */
        <div class="max-w-7xl mx-auto space-y-6">
          ...
          <div class="px-2">
            <h3 class="text-xl font-bold text-slate-800 mb-6">Pilih Layanan {categoryName}</h3>
        ...
        /* ========================================================= */
        /* MODE 2: TAMPILAN PRODUK & CHECKOUT (LEBAR 5XL + BANNER)   */
        /* ========================================================= */
        <div class="max-w-5xl mx-auto space-y-6">
          ...
          {/* HEADER KATEGORI (BANNER) HANYA MUNCUL JIKA LANGSUNG PRODUK */}
          <div class="relative rounded-3xl overflow-hidden bg-slate-900 min-h-[140px] md:min-h-[200px] shadow-xl">
             ...
             <div class="absolute bottom-0 left-0 p-6 md:p-8 flex flex-col justify-end h-full">
               ...
               <p class="text-slate-300 mt-2 text-sm md:text-base relative z-10">
                 Checkout instan. Tanpa daftar, langsung proses!
               </p>
             </div>
          </div>
          ...
          <div class="mt-8">
            {products.length === 0 ? (
              <div class="bg-slate-50 border border-slate-200 rounded-3xl p-12 text-center">
                ...
                <h2 class="text-lg font-bold text-slate-700">Kategori Kosong</h2>
                <p class="text-slate-500 text-sm mt-1">Belum ada produk publik atau sub-kategori di dalam layanan ini.</p>
              </div>
            ) : (
